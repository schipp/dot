...
__conda_setup="$('/Users/sven/conda/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/sven/conda/etc/profile.d/conda.sh" ]; then
        . "/Users/sven/conda/etc/profile.d/conda.sh"
    else
        export PATH="/Users/sven/conda/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
